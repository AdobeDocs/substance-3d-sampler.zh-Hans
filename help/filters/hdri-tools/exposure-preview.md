...
在上图中，已创建环境光，并且HDR图像数据在&#x200B;**2D视图**&#x200B;中可见。
...
**曝光度预览滤镜**&#x200B;的工作方式与其他Sampler滤镜略有不同。 此工具旨在帮助为您的环境光找到正确的曝光度，但它实际上根本不会影响环境通道 — 相反，当您将&#x200B;**曝光度预览滤镜**&#x200B;添加到图层栈叠时，将可以使用另一个通道在&#x200B;**2D视图**&#x200B;中查看 — 环境诊断通道。
