...
breadcrumb-title: ''
description: 使用Substance 3D Sampler中的图案生成器为素材纹理创建程序性图案和重复设计。
...
从可用选项之一为您的材质添加图案，或使用图像或画笔自定义自己的材质。
...
* <b>图案</b>：图像选取器和/或绘画\
  在纹理生成器中选择图案，或者导入一个图案
* <b>颜色模式选择</b>：仅素材或颜色\
  <b>材质</b>模式影响所有&#x200B;*PBR通道*，而<b>仅颜色</b>模式仅影响材质的&#x200B;*基色*。
* <b>颜色量</b>： 1-10\
  从图案中选择现用颜色的数量
* <b>色相</b>： 0-1\
  调整图案的色相
...
* <b>替换颜色： </b>切换\
  根据<b>颜色量</b>，替换选定的颜色
* <b>粗糙度</b>： 0-1\
  设置所选颜色的粗糙度，取决于<b>颜色量</b>
* <b>金属</b>： 0-1\
  设置所选颜色的粗糙度，取决于<b>颜色量</b>
* <b>浮雕模式</b>：切换\
  根据<b>“颜色量”</b>，选择所选颜色的浮雕方向
* <b>浮雕强度： </b>0-1<b>\
  </b>根据<b>颜色量</b>，调整所选颜色的浮雕强度
* <b>浮雕距离： </b>0-1\
  拉伸和平滑所选颜色的浮雕区域，具体取决于<b>颜色量</b>
* <b>浮雕颗粒： </b>0-1\
