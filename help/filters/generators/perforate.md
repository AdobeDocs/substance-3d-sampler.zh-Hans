---
helpx_url: "https://helpx.adobe.com/cn/substance-3d-sampler/filters/generators/perforate.html"
breadcrumb-title: ''
description: 使用Substance 3D Sampler中的穿孔生成器在材料和纹理中创建穿孔图案和孔阵列。
...
* **使用比例图**：切换\
  ...
  * **反转比例图**：切换\
    反转比例图的值
  * **自定义比例图**：图像/画笔\
    导入图像以用作比例图，或使用画笔直接在&#x200B;**2D** **视图**&#x200B;中绘画比例图
