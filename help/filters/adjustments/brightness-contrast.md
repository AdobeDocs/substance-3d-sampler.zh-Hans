...
breadcrumb-title: ''
description: 使用Substance 3D Sampler中的“亮度/对比度”滤镜调整纹理和素材图层中的亮度和对比度级别。
...
顾名思义，“亮度/对比度”滤镜允许您调整素材的亮度和对比度。 请务必注意，您可以使用“亮度/对比度”滤镜来定位特定通道。 例如，您可以增加粗糙度通道的对比度，或增加发射通道的亮度。

在下图中，**亮度/对比度滤镜**&#x200B;已用于增加拼贴素材的亮度和对比度。
...
* **频道选择**：\
  选择滤镜影响的通道。 注：您不能使用“亮度/对比度”滤镜来修改“正常”通道，因为它与大多数通道的行为不同。
* **亮度**： -1到1\
  修改所选通道的亮度
* **对比度**： -1到1\
  修改所选通道的对比度
