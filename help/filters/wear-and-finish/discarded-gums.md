...
breadcrumb-title: ''
description: 在Substance 3D Sampler中使用“丢弃的牙龈滤镜”向材料中添加残留的牙龈和粘性表面效果。
...
将废弃的口香糖添加到您的素材中。 此滤镜适用于创建人行道或其他用于公共行走区域的材料。在沥青材料上使用&#x200B;**丢弃的油漆**&#x200B;滤镜之前和之后。
...
* **胶布颜色分布平衡**： 0-1\
  调整每种颜色外观的相对频率。
* **口香糖老化**： 0-1\
  更改污点的外观，使其看起来更老或更年轻。 当此值设置为0时，**Gum Aging Variation**&#x200B;滑块将消失。
* **口香糖老化变化**： 0-1\
  随机改变污点的年龄
* **口香糖老化**： 0-1\
  调整污点因年龄增长而变暗的程度。
...
* **胶Dirt变化**：\
  调整Dirt在污点之间的差异程度。
* **自定义蒙版**：切换\
  启用或禁用自定义蒙版的使用。 如果启用&#x200B;**自定义蒙版**，则将显示以下控件：
  * **蒙版**：图像/画笔\
