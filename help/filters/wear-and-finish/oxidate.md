---
helpx_url: "https://helpx.adobe.com/cn/substance-3d-sampler/filters/wear-and-finish/oxidate.html"
breadcrumb-title: ''
description: 使用Substance 3D Sampler中的“Oxidate”（氧化）滤镜，为陈旧的金属材料添加氧化和褪色效果。
...
* **目标区域**：切换\
  能够更改氧化效果在材料上的应用方式。 启用后，将显示以下控件：
  * **目标区域强度**： 0-1\
    调整目标区域效果的扩散。
  * **正在分配**： 0-1\
    调整氧化性跨页的距离。
* **颜色**：颜色选择\
  选择滤镜的基色。 基色修改构成氧化效果的所有颜色的色相。
* **颜色变化**： 0-1\
  调整颜色变化效果的缩放比例。
* **密度**： 0-1\
  更改效果的覆盖密度。
...
以下参数允许您调整整个素材的命名值，而无需添加调整图层，例如&#x200B;**亮度/对比度**&#x200B;或&#x200B;**色相/饱和度**
