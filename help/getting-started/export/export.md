...
breadcrumb-title: ''
description: 了解如何从Substance 3D Sampler导出各种格式的材料和预设，以便在其他应用程序和引擎中使用。
...
您可以通过选择&#x200B;**“文件”菜单**&#x200B;中的&#x200B;**“导出为”**，或使用快捷键&#x200B;**Ctrl + E**&#x200B;来导出资源。这将打开[导出窗口](../../getting-started/export/export-window/export-window.md)，您可以在其中自定义导出。

>[!NOTE]
>
> 在&#x200B;**导出窗口**&#x200B;中，更改材质模型选项将更改导出的文件名以匹配所选材质模型。

![导出选择了材质设置的窗口](../../assets/6.0_ExportWindowMaterialSettings.png)

Sampler支持资源的主要文件格式：

* 素材可以导出为&#x200B;**SBS**&#x200B;或&#x200B;**SBSAR**&#x200B;文件。
* 或者，也可以使用以下文件格式导出每个通道的位图纹理：
  * **EXR**
  * **JPEG**
  * **PNG**
  * **TARGA**
