...
Sampler包含一系列导出预设，这些预设根据要导入到的软件为位图纹理打包并命名。
...
* [Unity HDRPSpecular](unity-hdrp-specular.md)
* [Unity Standard](unity-standard.md)
* [UnitySpecular](unity-specular.md)
* [虚引擎4](unreal-engine-4.md)
* [Redshift](redshift.md)
* [V-Ray下一个](v-ray-next.md)
