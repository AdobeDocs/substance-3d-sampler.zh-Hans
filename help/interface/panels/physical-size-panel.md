...
breadcrumb-title: ''
description: 了解如何使用Substance 3D Sampler中的“物理尺寸”面板为材料和纹理设置现实尺寸。
...
通过下列工具和参数，您可以定义材料的物理尺寸，并在对对象应用材料时创建准确而逼真的视觉效果。
...
**物理比例：**&#x200B;启用或禁用物理比例。 物理刻度是沿三个轴的网格圆周。\
使用物理值缩放材料。 操作Height(Y)和深度(Z)的宽度(X)。\
**拼贴：**&#x200B;设置您的材料拼贴

### 输出材质

帮助您用现实生活中的方面将材料的输出可视化。

**显示物理比例：**\
2D视口的显示会遵守物理比例。\
**Height比例：**&#x200B;基于物理比例从3D视口设置/计算。
