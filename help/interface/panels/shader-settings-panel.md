...
breadcrumb-title: ''
description: 了解如何使用Substance 3D Sampler中的“着色器设置”面板配置素材着色器属性和渲染选项。
...
在<b>着色器设置面板</b>中，您可以配置着色器如何在3D视口中渲染网格上的资源。

## 材质参数

材质参数允许您调整着色器渲染当前材质的方式。

| 参数名称 | 描述 |
| --- | --- |
| 法线强度 | 调整法线图的强度或强度。 |
| 合并法线和高度 | 切换是否将Height映射和正常映射组合到单个映射中。 |
| 高度水平 | 更改Height的基本级别。 |
| 自发光强度 | 调整发送图表的强度。 |
| 次表面散射 | 打开或关闭“子表面散射”。 |
| 折射指数 | 调整光线从表面折射的角度。 |
| 涂层折射指数 | 调整光线从表面皮毛折射出来的角度。 |
| 涂层法线强度 | 专门为表面涂层调整正常比例。 |
