...
Sampler中的每个面板都专用于特定的目的。 默认情况下，仅打开以下四个面板：
...
默认情况下，其余面板处于关闭状态，并按住通常不需要定期更改的选项和控件。 您可以从左侧和右侧边栏访问这些面板。
...
您可以通过移动面板来自定义工作区 — [查看界面页面以了解如何操作](../../interface/interface.md)。

要随时返回到默认工作区布局，请使用&#x200B;**窗口>重置为默认布局**。
